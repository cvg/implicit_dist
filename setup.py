...
setup(
    name="pyimplicitdist",
    version="1.0.0",
    author="Linfei Pan and Viktor Larsson",
    author_email="linpan@student.ethz.ch, viktor.larsson@math.lth.se",
    description="Camera pose estimation using implicit distortion",
    long_description="",
    ext_modules=[CMakeExtension("pyimplicitdist")],
